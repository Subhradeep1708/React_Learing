...
function App() {
    ...
    const addTodo = (todo) => {
        setTodos((prev) => [{ id: Date.now(), ...todo }, ...prev])//new todo injected at start
    }
    ...
    useEffect(() => {  //on page load all todos will come 
    ...
    useEffect(() => {  //on todos change setting the todos in localStorage  
